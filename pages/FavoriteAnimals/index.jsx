  ...
  useEffect(() => {
    if (!search) {
      ...
      let obj = {
        ...
        image:
          "//images.ctfassets.net/zrxg7ng9qct2/5J7gXBdokCfHrQTggwFZlk/9b5aed522b7acf75d79fa21b906d126f/clownfish.png",
        tabs: [
          {
            about: [
              {
                ...
                description:
                  "Red deep sea crab on the US east coast show distinct sex segregation by depth along the continental slope. Females predominate in depths of 450–700 m, and those in shallow water are predominantly reproductive adults, whereas males predominate at greater depths.",
            ...
            curiosities: [
              {
                curiositiesText:
                  "After mating, females carry fertilized eggs on their pleopods for up to 9 months until the larvae are released.",
                curiositiesImage: "assets/images/realAnimals/07-crab.jpg",
              },
            ],
            locationText:
              "Atlantic red crab or red crab is a crab that lives in the Atlantic Ocean off the East Coast of the United States and Canada, from North Carolina to Nova Scotia.",
        ...
        tabs: [
          {
            about: [
              {
                ...
                description:
                  "The jellyfish are mainly free-swimming marine animals with umbrella-shaped bells and trailing tentacles, although a few are anchored to the seabed by stalks rather than being mobile. The bell can pulsate to provide propulsion for highly efficient locomotion. ",
                height: "1cm - 40cm",
                weight: "20g - 400g",
              },
            ],
            breeding: [
              {
                method:
                  "Egg - planula - attached planula - polyp - budding polyp - juvenile - adult",
              },
            ],
            curiosities: [
              {
