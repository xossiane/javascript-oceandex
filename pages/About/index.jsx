  ...
  return (
    <>
      ...
      <section className={styles[`AboutPage__Header--info`]}>
        ...
        <AnimalsTag label={"Octopoda"}></AnimalsTag> <AnimalsTag label={"Mollusca"}></AnimalsTag>
        </section>
        <img src="assets/images/icons/16-octopus.png" className={styles[`AboutPage__Header--icon`]} alt="animal icon"></img>
        </section>
