      ...
      {newHero.map((dado) => (
        <div key={dado.id} className={styles[`Hero`]}>
          <div className={styles[`Hero__header`]}>
            <img className={styles[`Hero__mainCourse`]} src={dado.img} alt="illustrative"/>
            ...
            <div className={styles[`Hero__topContainer`]}>
              ...
              className={styles[`Hero__topContainer__icon`]}
                src={dado.miniIcon}
              /> 
              <Text size="small" weight="bold" className={styles[`Hero__topContainer__title`]}>{dado.categ} </Text>
              
            </div>
          </div>

          <div className={styles[`Hero__botContainer`]}>
            <h2 className={styles[`Hero__botContainer__title`]}>{dado.title}</h2>
            <Text size="large" className={styles[`Hero__botContainer__description`]}>{dado.desc}</Text>
