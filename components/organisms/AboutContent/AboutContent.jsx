  ...
  return (
    <div className={styles[`AboutContent__Container`]}>
      ...
      <section className={styles[`AboutContent__Container--about`]}>
        <Text color="black" size="small"> An octopus is a soft-bodied, eight-limbed mollusc of the order Octopoda. It consists of some 300 species and is grouped within the class Cephalopoda with squids, cuttlefish, and nautiloids.</Text>
        </section> 
        ...
        <section className={styles[`AboutContent__breeding`]}>
            ...
            <Text  color="black" size="medium">Breeding</Text>
            </div>
            <div className={styles[`AboutContent__breeding--method`]}>
            <Text  color="black" size="small" className={styles[`AboutContent__breeding--label`]}>Method</Text>
            <Text  color="black" size="small" className={styles[`AboutContent__breeding--label`]}>Egg - larvae - juvenile - adult</Text>
            </div>
        </section>
